...
public class DeathStar extends SpaceShip {
    ...
    public DeathStar(String id, SpaceShipRolType rol, double laserPower)
            throws SpaceShipException {
        super(id, PEOPLE_CAPACITY, CARGO_CAPACITY, rol);
    ...
    public String toString() {
        ...
        return "{ \"type\": \"DeathStar\", \"details\": " +
                super.toString() + ", \"laserPower\": " + df.format(laserPower) + " }";
    }
}